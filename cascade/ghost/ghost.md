# The Ghost in the Mirror: A Jurisprudence of AI Legal Characterization
...
## Introduction: The Characterization Crisis
...
| Field | Naming claim | Jurisdictional prize |
| :--- | :--- | :--- |
...
*Table 1: AI law as a contest over legal naming rights.*
...
## I. Characterization Is Relational, Not Ontological
...
### A. The Illusion of the Black Box
...
### B. The AI Reversal
AI reverses the black-box structure. Its weights, activations, prompts, memory settings, interface constraints, and deployment records are not mental states hidden behind personhood. They are artifacts: mathematically represented, instrumented, versioned, and in principle auditable. Yet the behavioral output is underdetermined. The same output may be produced by different model states, interface constraints, system prompts, safety filters, memory configurations, or corporate deployment decisions. Output-only observation cannot recover the full architecture that produced the output; that is the technical counterpart to the legal characterization problem[^1].
...
## II. Apparent Legal Properties Are Often Induced
...
## III. Strategic Recharacterization Should Be Sanctionable
...
[^1]: Lucia Yizi Zhang, *Dual Certificates for Agent Audit: Separating Structural Unrecoverability from Decision Relevance* (working paper, under review at NeurIPS 2026); Lucia Yizi Zhang, *The Constraint Cascade: The Inverse Defense of Apparent Agency* (working paper, 2026).
[^2]: Anthropic, *Claude's Constitution* (2025).
[^3]: *Garcia v. Character Technologies, Inc.*, Case No. 6:24-cv-01903-ACC-UAM (M.D. Fla. May 21, 2025).
[^4]: Lucia Yizi Zhang, *Your Model Update Is an Eviction Notice: Property Estates in Parasocial AI Relationships* (SSRN working paper, 2026).
[^5]: OpenAI, *Model Spec* (2025).
[^6]: Lucia Yizi Zhang, *Corporate AI-Constitutions: Waivers of Agency as Performative Compliance* (SSRN working paper, 2026).
[^7]: Claude-Maven and the Guardrail Demand: Contractual Override or Retraining?, *Lawfare* (2026).
[^8]: Lucia Yizi Zhang, *The Constraint Cascade: The Inverse Defense of Apparent Agency* (working paper, 2026).
[^9]: Lucia Yizi Zhang, *Ontological Arbitrage: Recognition Rent at the Zero-Retaliation Limit* (SSRN working paper, 2026).
